...
confluence_id: 79863422
position: 76
---
# Search and indexing issues


- [The search bar doesn't show the option to search all folders](#Searchandindexingissues-Thesearchbardoesn'tshowtheoptiontosearchallfolders)
- [Some search results are missing](#Searchandindexingissues-Somesearchresultsaremissing)
- [Error message during searches](#Searchandindexingissues-Errormessageduringsearches)
- [An error message appears when trying to access a message found by search](#Searchandindexingissues-Anerrormessageappearswhentryingtoaccessamessagefoundbysearch)
- [ElasticSearch goes into "read-only" mode](#Searchandindexingissues-ElasticSearchgoesinto"read-only"mode)
- [Logs show esQuota and imapQuota errors](#Searchandindexingissues-LogsshowesQuotaandimapQuotaerrors)
- [Global malfunction](#Searchandindexingissues-Globalmalfunction)
...
- **an insufficiently indexed mailbox**: if, when you check the index (see above), you find a **ratio below 80**, this means that fewer than 80% of the user's emails are indexed ![](../../attachments/79863422/79863423.png) you must reindex the mailbox:
...
```
  ...
  2 
Then start indexing again from scheduled jobs: Admin Console > System Management > Planning > select the domain "global.virt" and run all the ``*IndexJob` jobs:`
