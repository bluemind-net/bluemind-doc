...
The graph with the query results is shown at the bottom of the window. Refresh rates and interval settings are shown and can be edited at the top of the page, as well as in the dashboards:
 ![](../../../attachments/79863265/79863296.png)


****To look for and analyze a metric:** **

1 Select the database telegraf.autogen in the first column
1 In the search box in the second column (*"Measurements & tags")*, enter the name of the item you want to analyze – e.g. a BlueMind component – to view what metrics are available for it: ![](../../../attachments/79863265/79863295.png)
1 Select a metric by clicking it – e.g. "`bm-ysnp-authCount`" in this instance
1 
You can navigate within each metric so specify the data you are looking for:
  ...
  - **meterType**: data type, this field is particularly important as it specifies the kind of information contained in this metric 
    ...
    - *[distsum](#Exploringandanalyzingdatawithbmtick-distsum)*: counter-amount data paire.g.:
...
![](../../../attachments/79863265/79863294.png)
...
:::
1 Select the field in the third column according to the data you're looking for. The corresponding graph is then shown: ![](../../../attachments/79863265/79863293.png)
...
![](../../../attachments/79863265/79863292.png) change the number of days/hours as desired to increase or decrease the graph's timeframe. 
...
![](../../../attachments/79863265/79863291.png)

![](../../../attachments/79863265/79863292.png) the mean value keeps going up as additional authentications are being processed.
...
![](../../../attachments/79863265/79863290.png)

![](../../../attachments/79863265/79863292.png) A sudden spike of "failed" in the timeline could be the sign of an attack by spammers attempting to use the server to send emails.
...
![](../../../attachments/79863265/79863289.png)

![](../../../attachments/79863265/79863292.png) at 14:00 hours, there was a mean of 1.03 connections per minute, at 15:00 there was 0.5/mn, etc.
...
1 the second digit is an amount
...
To do this, you need to use the Dashboard's graphs (see next section):![](../../../attachments/79863265/79863288.png)
...
![](../../../attachments/79863265/79863287.png)
...
![](../../../attachments/79863265/79863286.png)

The dashboard is created immediately, and an empty view of it opens:

![](../../../attachments/79863265/79863285.png)

Click "*Name this dashboard*" to edit the box and enter a name for the dashboard:

![](../../../attachments/79863265/79863284.png)

To add a graph in the existing area, click ![](../../../attachments/79863265/79863283.png)
...
![](../../../attachments/79863265/79863282.png)
...
![](../../../attachments/79863265/79863288.png)
...
![](../../../attachments/79863265/79863281.png)

Click ![](../../../attachments/79863265/79863280.png) to add as many graph areas as you like:

![](../../../attachments/79863265/79863279.png)

In the top right corner of each cell, three buttons are used to:

- ![](../../../attachments/79863265/79863278.png): edit, add comments or download csv data
- ![](../../../attachments/79863265/79863277.png): clone the graph. A new area containing the same graph is added at the end of the dashboard
- ![](../../../attachments/79863265/79863276.png): delete the graph
...
![](../../../attachments/79863265/79863275.png)
...
![](../../../attachments/79863265/79863274.png)
...
- To create an alert, click ![](../../../attachments/79863265/79863273.png)
...
- ** **Time series****: use the navigator to find the relevant series 
  ...
  - **Fields**: the field(s) required for this data
- ** **Conditions****: once you have selected the field, set the conditions according to the type of alert chosen earlier.When you type a value, a real-time display of the data collected is shown which can help you set or adjust the value.For example in the form below: ![](../../../attachments/79863265/79863272.png) 
  ...
  - ![](../../../attachments/79863265/79863292.png) You can see that your values have always been below, it would be abnormal for them to exceed this value, therefore this threshold seems to be relevant. 
This can help you set the right value in light of the data's history: above typical values, possible spikes, etc.In this other example, an alert will be triggered when there are memory usage spikes every day: ![](../../../attachments/79863265/79863271.png)- ** **Alert** ** handlers****: Add alert recipients using the drop down list:
  ...
  - ...
In this example, the alert sends an http request, runs a command on the server and writes a message to the dedicated log file: ![](../../../attachments/79863265/79863270.gif)- ** **Message****: the message to write or send via the handler(s) specified above ![](../../../attachments/79863265/79863269.png)
...
- To create a script, click ![](../../../attachments/79863265/79863268.png)
...
![](../../../attachments/79863265/79863267.png)
...
![](../../../attachments/79863265/79863266.png)
