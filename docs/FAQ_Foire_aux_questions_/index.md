...
1 sélectionner le message dans la liste et cliquer sur le menu "Plus d'actions" au dessus de la liste des messages puis choisir "Éditer en tant que nouveau message"
...
Pour en savoir plus, consulter la page [La messagerie](/Guide_de_l_utilisateur/La_messagerie/)
...
Pour en savoir plus sur l'organisation des colonnes, consulter la page [La messagerie](/Guide_de_l_utilisateur/La_messagerie/) > chapitre 4.1 - Colonnes et tri
...
1 l'administrateur de domaine peut autoriser les synchronisations individuellement via la console d'administration > Entrées d'annuaire > choix de l'utilisateur > onglet "Périphérique"
...
1 aller dans la gestion des comptes.NB : Le nom de cette section varier d'un appareil à l'autre : "Comptes", "Comptes & utilisateurs", etc.
1 choisir le compte correspondant à la synchronisation BlueMind
1 aller dans les paramètres de synchronisation
1 appuyer sur "*Synchroniser maintenant*"NB : Selon les modèles, cette action peut se trouver en accès direct ou dans un menu *sandwich* (trois points ou trois traits en haut de l'écran)
...
1 Si vous n'accédez plus à la console, faites en ligne de commande :
  - 
