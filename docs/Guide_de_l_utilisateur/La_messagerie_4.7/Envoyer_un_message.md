...
Le champ de l'**expéditeur** peut être affiché en sélectionnant l'option "**Afficher le champ "De"**" dans la barre d'outil principale sous "Autres". Cela permet de pouvoir choisir l'[identité](/STAGING/Guide_de_l_utilisateur_4.7/La_messagerie_4.7/Gérer_les_identités_du_compte/) avec laquelle l'e-mail doit être envoyé.
...
Les messages en cours d'édition s'enregistrent automatiquement comme brouillon. Pour le retrouver et reprendre l'édition ultérieurement, aller dans le dossier **Brouillons** de la [liste des dossiers](/STAGING/Guide_de_l_utilisateur_4.7/La_messagerie_4.7/Organiser_les_dossiers/).
...
Pièces jointes
Les images et autres fichiers peuvent également être ajoutés en [pièces jointes](/STAGING/Guide_de_l_utilisateur_4.7/La_messagerie_4.7/Ajouter_des_pièces_jointes/)
:::
...
BlueMind permet aux utilisateurs d'utiliser **différentes signatures en fonction de l'expéditeur**. Les signatures sont paramétrées dans les [identités](/STAGING/Guide_de_l_utilisateur_4.7/La_messagerie_4.7/Gérer_les_identités_du_compte/) du compte.
...
Par exemple ici, les signatures sont différentes selon que John Smith écrit en son nom ou au nom de la [boite aux lettres partagée](/STAGING/Guide_de_l_utilisateur_4.7/La_messagerie_4.7/Utiliser_une_messagerie_partagée/) du service documentation :
