...
1 Cliquez sur le bouton "Paramétrer le compte"
1 Un avertissement peut apparaître, validez alors l'exception demandée pour le certificat puis cliquez de nouveau sur "Paramétrer le compte"
1 La popup se ferme est le fichier est alors joint au message
...
1 
Supprimer le dossier de stockage local :
